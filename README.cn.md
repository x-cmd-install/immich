...
- **上游仓库**: <https://github.com/immich-app/immich>
- **官网**: <https://immich.app>
- **许可证**: AGPL-3.0
...
- **Star**: 113,792 · **Fork**: 6,870 · **开放 issue**: 9,290 · **贡献者**: 2,319

## 累计统计

- **发布数**: 309 · **已合并 PR**: 10225 · **开放 PR**: 242 · **已关闭 issue**: 8793 · **开放 issue**: 497 · **提交数**: 10966

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 4 | 190 | 93 | 113 | 70 | 289 |
| last60d | 2026-07-13 | 6 | 432 | 137 | 293 | 134 | 672 |
| 90d | 2026-06-13 | 13 | 682 | 169 | 519 | 183 | 1139 |
| last180d | 2026-03-15 | 22 | 1381 | 223 | 986 | 254 | 2250 |
| 360d | 2025-09-16 | 42 | 2753 | 240 | 2282 | 385 | 4968 |
| last720d | 2024-09-21 | 100 | 5586 | 242 | 5065 | 475 | 5666 |
...
在 [repology.org](https://repology.org/project/immich) 上共有 **12** 个发行版报告此项目。**6** 个 ✅ 已是最新上游版本，**4** 个 ⚠️ 使用旧版本。
...
immich 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `immich` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/immich.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T04:37:06Z._
